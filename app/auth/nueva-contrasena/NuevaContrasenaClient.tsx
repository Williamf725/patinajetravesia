...
interface NuevaContrasenaClientProps {
  token: string;
  email: string;
}

export default function NuevaContrasenaClient({ token, email }: NuevaContrasenaClientProps) {
      ...
      >
        ...
        {state?.success ? (
          ...
          <form action={formAction} className="space-y-6">
            {/* Campos hidden con valores desde props del Server Component */}
